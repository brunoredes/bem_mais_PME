...
export class DashComissaoGerenteService {
    ...
    private _requestComissionVendor() {
        return this.request.getGerente(
            '7_Menu_Dashboard/3_Comissoes/1_Comissoes_Vendedor_Response.json'
        );
    }
    ...
    private _requestTopFive() {
        return this.request.getGerente(
            '7_Menu_Dashboard/3_Comissoes/2_Top_Comissoes_Response.json'
        );
    }
    ...
    private _requestHistorySales() {
        return this.request.getGerente(
            '7_Menu_Dashboard/3_Comissoes/3_Historico_Vendas_Trimestre_Response.json'
        );
    }
